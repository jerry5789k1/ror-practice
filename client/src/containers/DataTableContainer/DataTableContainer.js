...
export default class DataTableContainer extends React.Component {
  ...
  componentDidMount = () => {
    axios
      .get("api/getAllTurnOverData")
      .then(res => this.setState({ turnOverData: res.data }));
    axios
      .get("api/getAllDate")
      .then(res => this.setState({ dateOptions: res.data }));
    axios
      .get("api/getAllCode")
      .then(res => this.setState({ stockCodeOptions: res.data }));
  };
    ...
    return (
      <React.Fragment>
        ...
        <DataTable
          ...
          getSortingData={this.getSortingData}
        />
      </React.Fragment>
    );
  }
